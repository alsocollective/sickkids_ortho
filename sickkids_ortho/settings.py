# Django settings for sickkids_ortho project.
...
STATIC_ROOT = SITE_ROOT + '/../static-files/'
...
SECRET_KEY = '#9-k7f!=tr^5)18*&nanwl(@b_q33#v(1v0jp5^n(%l-*11q!#'
...
ROOT_URLCONF = 'sickkids_ortho.urls'
...
INTERNAL_IPS = ('127.0.0.1', '198.74.53.119')
